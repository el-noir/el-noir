...
[![Portfolio](https://img.shields.io/badge/Portfolio-mudasirshah.live-58a6ff?style=for-the-badge&logo=safari&logoColor=white)](https://mudasirshah.live)
[![0Fill](https://img.shields.io/badge/0Fill-Live%20Product-3fb950?style=for-the-badge&logo=vercel&logoColor=white)](https://0fill.vercel.app)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077b5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/mudasir-shah-1b6400279)
[![Email](https://img.shields.io/badge/Email-Contact-ea4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mudasirshah9777@gmail.com)
...
> Full-stack developer with hands-on experience building production-ready web applications across React, Next.js, Node.js, NestJS, PostgreSQL, and Python. Strong background in scalable backend systems, polished frontend interfaces, and AI-enabled products using LLMs, RAG pipelines, and speech-to-text workflows. Brings an ownership mindset from idea to deployment and focuses on turning product requirements into reliable user-facing systems
...
|---------|-------------|--------|-------|
| **[0Fill](https://0fill.vercel.app)** | AI SaaS converting forms into conversations | Replaced Traditional Forms | NestJS · Claude API · Redis · BullMQ |
| **KOEN** | Voice-first PWA for construction workers | 80–90% less manual effort | NestJS · Whisper · Groq · PostgreSQL |
| **[SurfAI](https://github.com/el-noir/SurfAI)** | LangGraph browser automation agent | Vision-powered natural language control | LangGraph · Groq Vision · FastAPI · Docker |
| **AirGPT** | RAG system for Air University | Replaced manual search with instant AI | FastAPI · Qdrant · LangChain · Python |
| **StoreMaster** | Real-time inventory + billing platform | WebSocket live updates + Stripe | NestJS · Next.js · PostgreSQL · Stripe |
| **[Aventra](https://github.com/el-noir/aventra2)** | Multi-platform webhook normalization | Stripe · HubSpot · unified schema | NestJS · PostgreSQL · Prisma |
...
<!-- ![Mudasir's GitHub Stats](https://el-noir2-ch66z2iy4-mudasirshah434s-projects.vercel.app/api?username=mudasirshah&show_icons=true) 
  ...
  <img width="440px" src="https://github-readme-activity-graph.vercel.app/graph?username=el-noir&theme=github&area=true&hide_border=true&custom_title=GitHub%20Activity%20Graph">
  
  <img width="385px" src="https://github-readme-streak-stats.herokuapp.com/?user=el-noir&theme=onedark&cache_seconds=1800" />
  <img width="385px" src="https://el-noir3.vercel.app/api/top-langs/?username=el-noir&layout=pie" />
